...
public class SelectTankScreen2 extends ScreenAdapter {
    ...
    public void show() {
        ...
        Image tank = new Image(new Texture(Gdx.files.internal("img/tank2.png")));
        tank.setOrigin(0,0);
        tank.setSize(300*1.1f,170*1.1f);
        tank.setPosition(230,150);


        Label title = new Label("PLAYER 2",skin,"title");
        title.setOrigin(0,0);
        title.setPosition(165,340);
        title.setSize(400,120);

        Label tank_name = new Label("Frost",skin,"default");
        tank_name.setOrigin(0,0);
        tank_name.setFontScale(1.6f);
        tank_name.setPosition(330,50);
    ...
    private void initButtons() {
        ...
        select.addListener(new ClickListener() {
            @Override
            public void clicked(InputEvent event, float x, float y) {
                game.setScreen((Screen) new GameMech(game));
            }
        });
        stage.addActor(back);
